...
Regions with more than 2000 confirmed cases increased rapidly from a few to many.
...
```{r}
ggplot(subset(m5, Region=='US' | Region=='France' | Region=='Italy' | Region =='Sweden' |
...
```{r}
m8s = subset(m8, Region=='US' | Region=='India' | Region=='Korea, South' | Region =='Sweden' |
...
m8b = data.frame(DateDaysNorm = 10:40,
                 Confirmed = predict(fit, list(DateDaysNorm=10:40)))
